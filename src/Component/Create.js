...
const Create =()=>{
    ...
    const handlesubmit=(e)=>{
      e.preventDefault();
      axios.post("http://localhost:8001/api/student/post",inputData).then((res)=>{
            ...
            <div className="row">
                ...
                <div className="col-md-6 mt-3">
                  ...
                  <div className="col-4">
                   ...
                   <div className="col-8">
                   <TextField id="outlined-basic" placeholder="Enter your first name" variant="outlined" fullWidth
